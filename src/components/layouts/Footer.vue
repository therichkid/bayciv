      ...
      <v-row align="center">
        ...
        <v-col cols="12" sm="6">
          ...
          <v-card-text>
            ...
            <p class="mt-5 link">
              Newsletter <router-link to="/datenkontrolle">abbestellen</router-link>.
            </p>
          </v-card-text>
        </v-col>
        <v-col cols="12">
  ...
  data() {
    return {
      contact: [
        ...
        {
          icon: "mdi-instagram",
          text: "<a href=' https://www.instagram.com/bayciv' target='_blank' rel='noopener noreferrer'>Instagram</a>"
        }
      ],
      menu: [
        {
